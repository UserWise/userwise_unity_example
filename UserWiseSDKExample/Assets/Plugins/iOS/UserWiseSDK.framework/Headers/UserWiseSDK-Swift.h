...
@class UserWiseStyleConfiguration;
@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC11UserWiseSDK23SurveyWebViewController")
@interface SurveyWebViewController : UIViewController
+ (void)loadControllerWithSurveyUrl:(NSString * _Nonnull)surveyUrl styleConfiguration:(UserWiseStyleConfiguration * _Nonnull)styleConfiguration;
...
@property (nonatomic, strong) UserWiseStyleConfiguration * _Nonnull styleConfiguration;
...
SWIFT_CLASS("_TtC11UserWiseSDK26UserWiseStyleConfiguration")
@interface UserWiseStyleConfiguration : NSObject
