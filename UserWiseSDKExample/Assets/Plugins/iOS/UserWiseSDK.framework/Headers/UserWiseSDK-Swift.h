...
- (void)updateState:(enum OfferImpressionState)state;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
+ (void)loadControllerWithSurveyUrl:(NSString * _Nonnull)surveyUrl splashScreenStyles:(SurveySplashScreenStyles * _Nonnull)splashScreenStyles responseId:(NSString * _Nonnull)responseId;
...
- (void)initializeSurveyInviteWithResponseId:(NSString * _Nonnull)responseId;
- (void)setSurveyInviteResponseWithResponseId:(NSString * _Nonnull)responseId inviteId:(NSString * _Nonnull)inviteId wasAccepted:(BOOL)wasAccepted;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (void)onOfferAvailableWithOfferId:(NSString * _Nonnull)offerId;
/// Called when an offer impression initialization request fails.
- (void)onOfferImpressionInitializationFailedWithOfferId:(NSString * _Nonnull)offerId;
...
/// Called on refresh, when no survey is available for the appuser to take.
